module github.com/GoogleCloudPlatform/blueprints/test/integration
...
require (
	...
	github.com/GoogleContainerTools/kpt-functions-sdk/go/api v0.0.0-20250603063834-9af8fef0fca3 // indirect
